...
import Controlador.EventoInsertarUnaReunion;
 ...
 */
public class VentanaInsertarReunion extends JDialog {
   ...
   private JTable jtReuniones; 
    ...
    public VentanaInsertarReunion(JFrame ventana , JTable jtReuniones) {
      super(ventana);
      ...
      jlTitulo = new JLabel("Insertar Reunión");
      ...
      jbInsertar.addActionListener( new EventoInsertarUnaReunion(jtReuniones , jtfHoraInicio , jtfHoraTermino , jtfTipo ,  jtfCosto ,  jtfPastor ,  jtfCapacidad) );
